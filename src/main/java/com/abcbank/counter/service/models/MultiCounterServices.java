...
public enum  MultiCounterServices {
	ACC_OPEN(BankService.ACC_OPEN, new BankService[]{BankService.get(
			BankService.REGISTRATION.name()),
	...
	static BankService[] getActionItemsByService(BankService service){
